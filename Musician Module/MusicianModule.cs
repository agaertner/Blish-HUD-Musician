...
namespace Nekres.Musician
{
    ...
    public class MusicianModule : Module
    {
        ...
        private List<MusicSheet> _rawMusicSheets;
        ...
        private Dictionary<ISoundRepository> _soundRepository;

        protected override void Initialize()
        {
            _soundRepository = new List<ISoundRepository>()
            {
        ...
        {
            foreach (var soundRepository in _soundRepository) await soundRepository.Initialize();
        ...
        {
            foreach (var soundRepository in _soundRepository) soundRepository.Dispose();
